...
- The M8 Real LLM Specification remains the Contract Authority / Implementation & Acceptance Baseline for M8. It covers provider-neutral LLM capability contracts, structured outputs, prompt/context architecture, invocation runtime, DeepSeek candidate evaluation, baseline promotion, security/telemetry boundaries, and aggregate Real Cloud exit gates, while preserving M1-M7 stable semantics. The M8 formal closure records M8-U1 through M8-U7, Hybrid Recovery U6H-A/B/C/D, M8-U6H-CA01, historical Parser/Patch Real LLM P0 failure recovery, U6H-D evidence bundle `project-docs/03_implementation-roadmap/milestones/M8/M8-U6H-D_Hybrid_Eval_Evidence_V1.0.json`, Aggregate Exit Gate G1 through G17, and 2026-08-29 unified CI as PASS, with Additional Contract Amendment NONE. M8 status: CLOSED / PASS. M9 status: READY / eligible for planning and specification only; M9 implementation not started.

...
- The M7 Patch + Impact + Orchestrator Specification is the Contract Authority / Implementation & Acceptance Baseline for M7. It covers Requirement Semantic Diff, ImpactDecision, DataAction, selective ExecutionPlan, execution concurrency, Version Guard, and Publication Guard, while preserving M1-M6 stable semantics. M7 status: SPECIFICATION ACCEPTED; M7-U1 Requirement Semantic Diff Foundation is eligible to start. Current Contract Amendment: NONE.

...
- The M6 Complete Decision Engine Specification is the Contract Authority / Implementation & Acceptance Baseline for M6. It covers Derived Feature, Complete Filtering, Complete Ranking, Recommendation Selector, Deterministic Relaxation, Golden Scenarios, and Aggregate Exit Gate scope. M6-CA01 is an accepted additive Contract Amendment Authority for MAX_PRICE as a formal Money-valued OFFER-scoped hard constraint and a VALUE_RELAXABLE family; CA01 preserves SearchPlan/Candidate Universe boundaries by default, does not authorize Requirement mutation, Patch commit, Search/Provider invocation, MAX_STOPS, provider-side price pushdown, FX conversion, M7 capability, or Publication Guard. M6 status: READY / IMPLEMENTATION ACTIVE; CA01 implementation is PENDING; M6-U6 remains blocked until CA01 implementation lands; M6 is not CLOSED. M7 remains not ready until M6 implementation, Aggregate Exit Gate, formal closure, and authority closure update are complete. Contract Amendment M6-CA01 ACCEPTED / implementation PENDING.

...
Prompt template version: patch-understanding-v1
...
operations minimal and targeted. Preserve ambiguous references or insufficient
context instead of guessing. Do not use full conversation history, full patch
history, candidate snapshots, provider raw data, rankings, recommendations,
impact decisions, execution plans, or publication state.
